...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda A adalah benar -->
  ...
  <p>Paket dplyr lebih umum digunakan untuk manipulasi data</p>
  <div class="correct-info">
    <p>ggplot2 adalah paket R yang digunakan untuk membuat visualisasi data yang kompleks dan estetis.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "correct-answer" ini menjadi "wrong-answer" jika pilihan ganda B adalah salah -->
  ...
  <p>Meskipun ggplot2 dapat digunakan dalam konteks analisis statistik, fokus utamanya adalah visualisasi.</p>
  <div class="correct-info">
    <p>ggplot2 adalah paket R yang digunakan untuk membuat visualisasi data yang kompleks dan estetis.</p>
...
correct-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda C adalah benar -->
  ...
  <p>ggplot2 adalah paket R yang digunakan untuk membuat visualisasi data yang kompleks dan estetis.</p>
  <div class="correct-info">
    <p>ggplot2 adalah bagian dari koleksi paket tidyverse dan didasarkan pada Grammar of Graphics, yang memungkinkan pengguna untuk membangun grafik secara bertahap dengan menambahkan lapisan.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda D adalah benar -->
  ...
  <p>Paket seperti tm atau stringr lebih cocok untuk pengolahan teks.</p>
  <div class="correct-info">
    <p>ggplot2 adalah paket R yang digunakan untuk membuat visualisasi data yang kompleks dan estetis./p>
    <!-- ================== Edit Diantara ini ============= -->
...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      R Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Apa kegunaan utama dari paket ggplot2 dalam R?
