...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda A adalah benar -->
  ...
  <p>Tidak ada perintah \start{document} dalam LaTeX.</p>
  <div class="correct-info">
    <p>Perintah \begin{document} digunakan untuk memulai isi utama dokumen./p>
    <!-- ================== Edit Diantara ini ============= -->
...
correct-answer  <!--Ubah bagian kiri ini, yaitu "correct-answer" ini menjadi "wrong-answer" jika pilihan ganda B adalah salah -->
  ...
  <div class="extra-info">
    <p>Semua konten yang akan ditampilkan dalam dokumen harus ditempatkan antara \begin{document} dan \end{document}</p>
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda C adalah benar -->
  ...
  <p>\document{} bukan perintah yang valid dalam LaTeX.</p>
  <div class="correct-info">
    <p>Perintah \begin{document} digunakan untuk memulai isi utama dokumen.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda D adalah benar -->
  ...
  <p>Tidak ada perintah \main{document} dalam LaTeX.</p>
  <div class="correct-info">
    <p>Perintah \begin{document} digunakan untuk memulai isi utama dokumen.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      LaTeX Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Perintah apa yang digunakan untuk memulai isi utama dokumen dalam LaTeX?
