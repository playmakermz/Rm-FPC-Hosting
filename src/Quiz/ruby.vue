...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      Ruby Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Apa yang dilakukan oleh perintah <strong>gets.chomp</strong> dalam Ruby?
<!-- =================== Diantara ini, silahkan ubah. Digunakan untuk penulisan soal ===================== -->    
    </h2>
  </div>
    ...
    <div class="answers-grid">
      <button 
        ...
        <span class="answer-text">
          ...
          Membaca input dari pengguna dan menghapus karakter newline di akhir
      ...
      >
        ...
        <span class="answer-text">
          ...
          Menghapus semua spasi dari input pengguna
