...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda A adalah benar -->
  ...
  <p>Vue CLI bukan alat untuk mengedit file HTML secara manual.</p>
  <div class="correct-info">
    <p>Vue CLI adalah alat untuk membantu dalam pembuatan dan pengelolaan proyek Vue.js dengan cepat dan efisien.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "correct-answer" ini menjadi "wrong-answer" jika pilihan ganda B adalah salah -->
  ...
  <p>Meskipun Vue CLI memiliki antarmuka grafis (Vue UI), tujuan utamanya bukan hanya menyediakan GUI.</p>
  <div class="correct-info">
    <p>Vue CLI adalah alat untuk membantu dalam pembuatan dan pengelolaan proyek Vue.js dengan cepat dan efisien.</p>
...
correct-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda C adalah benar -->
  ...
  <div class="extra-info">
    <p>Vue CLI menyediakan perintah untuk membuat proyek baru, menjalankan server pengembangan, membangun proyek untuk produksi, dan banyak lagi. Ini mempermudah pengembang dalam mengatur struktur proyek dan mengintegrasikan berbagai fitur dengan cepat.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda D adalah benar -->
  ...
  <p>Vue CLI tidak mengganti bahasa pemrograman JavaScript dengan Python.</p>
  <div class="correct-info">
    <p>Vue CLI adalah alat untuk membantu dalam pembuatan dan pengelolaan proyek Vue.js dengan cepat dan efisien./p>
    <!-- ================== Edit Diantara ini ============= -->
...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      VueJS Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Apa tujuan dari menggunakan Vue CLI dalam pengembangan aplikasi Vue.js?
    ...
    <div class="answers-grid">
      <button 
        ...
        <span class="answer-text">
          ...
          Mengedit file HTML secara manual
      ...
      >
        ...
        <span class="answer-text">
          ...
          Menyediakan antarmuka grafis untuk pengguna
      ...
      >
        ...
        <span class="answer-text">
          ...
          Membantu dalam pembuatan dan pengelolaan proyek Vue.js dengan cepat
      ...
      >
        ...
        <span class="answer-text">
          ...
          Mengganti bahasa pemrograman JavaScript dengan Python
