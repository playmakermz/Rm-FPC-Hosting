...
correct-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda A adalah benar -->
  ...
  <p>Untuk mendefinisikan parameter opsional, tambahkan tanda ? setelah nama parameter, misalnya: function greet(name?: string) { ... }.</p>
  <div class="extra-info">
    <p>Parameter opsional memungkinkan fungsi dipanggil dengan jumlah argumen yang bervariasi. Ini berguna untuk fungsi yang dapat beroperasi dengan atau tanpa beberapa parameter, meningkatkan fleksibilitas fungsi tersebut.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "correct-answer" ini menjadi "wrong-answer" jika pilihan ganda B adalah salah -->
  ...
  <p>Menetapkan nilai default membuat parameter memiliki nilai default, tetapi tidak menjadikannya opsional dalam arti TypeScript.</p>
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda C adalah benar -->
  ...
  <p>Mendeklarasikan parameter sebagai any tidak menjadikannya opsional.</p>
  <div class="correct-info">
    <p>Untuk mendefinisikan parameter opsional, tambahkan tanda ? setelah nama parameter, misalnya: function greet(name?: string) { ... }.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      TypeScript Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Bagaimana cara mendefinisikan parameter opsional dalam fungsi TypeScript?
<!-- =================== Diantara ini, silahkan ubah. Digunakan untuk penulisan soal ===================== -->    
    </h2>
  </div>
    ...
    <div class="answers-grid">
      <button 
        ...
        <span class="answer-text">
          ...
          Dengan menambahkan tanda ? setelah nama parameter
      ...
      >
        ...
        <span class="answer-text">
          ...
          Dengan menetapkan nilai default menggunakan tanda =
      ...
      >
        ...
        <span class="answer-text">
          ...
          Dengan mendeklarasikan parameter sebagai any
      ...
      >
        ...
        <span class="answer-text">
          ...
          Dengan menempatkan parameter di akhir daftar parameter
