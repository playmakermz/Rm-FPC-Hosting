...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      CSS Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
<strong>Apa tujuan dari media query dalam CSS?</strong>
    ...
    <div class="answers-grid">
      <button 
        ...
        <span class="answer-text">
          ...
          Menentukan jenis media yang digunakan untuk menampilkan halaman web
      ...
      >
        ...
        <span class="answer-text">
          ...
          Mengatur tampilan halaman web berdasarkan kondisi perangkat pengguna
      ...
      >
        ...
        <span class="answer-text">
          ...
          Menghubungkan file CSS eksternal dengan dokumen HTML
      ...
      >
        ...
        <span class="answer-text">
          ...
          Menambahkan interaktivitas pada elemen halaman web
