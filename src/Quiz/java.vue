...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda A adalah benar -->
  ...
  <p>Kompilasi dilakukan oleh javac, bukan JVM.</p>
  <div class="correct-info">
    <p>JVM menjalankan bytecode Java yang dihasilkan oleh proses kompilasi.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
correct-answer  <!--Ubah bagian kiri ini, yaitu "correct-answer" ini menjadi "wrong-answer" jika pilihan ganda B adalah salah -->
  ...
  <div class="extra-info">
    <p>JVM adalah mesin virtual yang memungkinkan komputer menjalankan program Java. Ia menerjemahkan bytecode menjadi instruksi mesin yang dapat dijalankan oleh sistem operasi. Hal ini memungkinkan Java untuk menjadi bahasa yang platform-independent.</p>
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda C adalah benar -->
  ...
  <p>Pengeditan file dilakukan oleh editor teks atau IDE, bukan JVM.</p>
  <div class="correct-info">
    <p>JVM menjalankan bytecode Java yang dihasilkan oleh proses kompilasi.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda D adalah benar -->
  ...
  <p>JVM tidak digunakan untuk menghapus file.</p>
  <div class="correct-info">
    <p>JVM menjalankan bytecode Java yang dihasilkan oleh proses kompilasi.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      Java Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Apa peran dari Java Virtual Machine (JVM) dalam eksekusi program Java?
