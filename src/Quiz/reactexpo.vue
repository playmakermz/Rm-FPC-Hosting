...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda A adalah benar -->
  ...
  <p>Expo justru mengurangi kebutuhan konfigurasi manual.</p>
...
correct-answer  <!--Ubah bagian kiri ini, yaitu "correct-answer" ini menjadi "wrong-answer" jika pilihan ganda B adalah salah -->
  ...
  <div class="extra-info">
    <p>Expo SDK mencakup berbagai modul seperti kamera, lokasi, dan notifikasi, yang dapat langsung digunakan tanpa perlu konfigurasi native tambahan, mempercepat proses pengembangan.</p>
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda C adalah benar -->
  ...
  <p>Expo mendukung pengembangan untuk Android dan iOS.</p>
  <div class="correct-info">
    <p>Expo menyediakan modul dan library siap pakai, seperti navigasi, yang mempermudah pengembangan aplikasi.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
wrong-answer  <!--Ubah bagian kiri ini, yaitu "wrong-answer" ini menjadi "correct-answer" jika pilihan ganda D adalah benar -->
  ...
  <p>Expo dibangun di atas React Native dan tidak menggantikannya.</p>
  <div class="correct-info">
    <p>Expo menyediakan modul dan library siap pakai, seperti navigasi, yang mempermudah pengembangan aplikasi.</p>
    <!-- ================== Edit Diantara ini ============= -->
...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      React Expo Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Apa keuntungan menggunakan Expo dalam pengembangan aplikasi mobile?
    ...
    <div class="answers-grid">
      <button 
        ...
        <span class="answer-text">
          ...
          Mengharuskan konfigurasi manual untuk setiap fitur
      ...
      >
        ...
        <span class="answer-text">
          ...
          Menyediakan modul dan library siap pakai seperti navigasi
      ...
      >
        ...
        <span class="answer-text">
          ...
          Membatasi pengembangan hanya untuk platform Android
      ...
      >
        ...
        <span class="answer-text">
          ...
          Menghilangkan kebutuhan akan React Native
