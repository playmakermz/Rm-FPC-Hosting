...
<div class="quiz-container">
  ...
  <div class="quiz-header">
    ...
    <h1 class="quiz-title">
      ...
      Git Challenge <!-- <= Ini Untuk Nama Mapel, sesuaikan dengan kebutuhan! -->
...
Apa perbedaan utama antara perintah git pull dan git fetch?
<!-- =================== Diantara ini, silahkan ubah. Digunakan untuk penulisan soal ===================== -->    
    </h2>
  </div>
    ...
    <div class="answers-grid">
      <button 
        ...
        <span class="answer-text">
          ...
          git pull hanya mengambil perubahan tanpa menggabungkannya, sedangkan git fetch mengambil dan langsung menggabungkan perubahan
      ...
      >
        ...
        <span class="answer-text">
          ...
          git pull mengambil dan langsung menggabungkan perubahan, sedangkan git fetch hanya mengambil perubahan tanpa menggabungkannya
      ...
      >
        ...
        <span class="answer-text">
          ...
          git pull digunakan untuk menghapus branch, sedangkan git fetch digunakan untuk membuat branch baru
      ...
      >
        ...
        <span class="answer-text">
          ...
          Tidak ada perbedaan; keduanya melakukan fungsi yang sama
